...
export interface OldPublicTransportLineCardProps {
  line: Line;
}

const OldPublicTransportLineCard = (props: OldPublicTransportLineCardProps) => {
...
export default OldPublicTransportLineCard;
