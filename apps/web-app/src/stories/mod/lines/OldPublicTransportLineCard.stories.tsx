...
const meta = {
  title: 'Module Elements/PublicTransport/OldPublicTransportLineCard',
  tags: ['autodocs'],
  component: MyOldPublicTransportLineCard,
} satisfies Meta<typeof MyOldPublicTransportLineCard>;
