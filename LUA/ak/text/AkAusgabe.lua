...
fmt = {
    ...
    hintergrund_gruen = function(text) return "<bgrgb=0,192,0>" .. text .. "<bgrgb=255,255,255>" end,
    hintergrund_blau = function(text) return "<bgrgb=128,128,255>" .. text .. "<bgrgb=255,255,255>" end,
    hintergrund_gelb = function(text) return "<bgrgb=224,224,0>" .. text .. "<bgrgb=255,255,255>" end,
    hintergrund_grau = function(text) return "<bgrgb=196,196,196>" .. text .. "<bgrgb=255,255,255>" end,
    hintergrund_rot = function(text) return "<bgrgb=255,96,96>" .. text .. "<bgrgb=255,255,255>" end,
