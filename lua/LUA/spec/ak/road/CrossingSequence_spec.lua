insulate("Crossing", function()
    ...
    describe("Lane sequence NONE -> A", function()
        local r, g = sequenceA:lanesToTurnRedAndGreen()
    ...
    describe("Lane sequence NONE -> B", function()
        local r, g = sequenceB:lanesToTurnRedAndGreen()
        it("Red   length", function() assert(0, #r) end)
    ...
    describe("Lane sequence B -> A", function()
        local r, g = sequenceA:lanesToTurnRedAndGreen(sequenceB)
    ...
    describe("Lane sequence B -> C", function()
        local r, g = sequenceC:lanesToTurnRedAndGreen(sequenceB)
    ...
    describe("Lane sequence C -> B", function()
        local r, g = sequenceC:lanesToTurnRedAndGreen(sequenceB)
        it("Red   length", function() assert(1, #r) end)
        it("Red   lane2 ", function() assert(lane2, r[1]) end)
        it("Green length", function() assert(1, #g) end)
    ...
    describe("Lane sequence A -> A", function()
        local r, g = sequenceA:lanesToTurnRedAndGreen(sequenceA)
        it("Red   length", function() assert(0, #r) end)
        it("Green length", function() assert(0, #g) end)
    end)
    describe("Lane sequence B -> B", function()
        local r, g = sequenceB:lanesToTurnRedAndGreen(sequenceB)
        it("Red   length", function() assert(0, #r) end)
        it("Green length", function() assert(0, #g) end)
    end)
    describe("Lane sequence C -> C", function()
        local r, g = sequenceC:lanesToTurnRedAndGreen(sequenceC)
        it("Red   length", function() assert(0, #r) end)
        it("Green length", function() assert(0, #g) end)
    end)
end)
