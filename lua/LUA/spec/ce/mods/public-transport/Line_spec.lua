insulate("Line Management Ring Line", function()
    ...
    local RSDM = require("ce.mods.public-transport.models.RoadStationDisplayModel")
...
insulate("Line Management 4 Line segments", function()
    ...
    -- Public Transport
    local PublicTransportCeModule = require("ce.mods.public-transport.PublicTransportCeModule")
    local Line = require("ce.mods.public-transport.Line")
    ...
    ControlExtension.addModules(CoreCeModule, DataCeModule, CrossingCeModule, PublicTransportCeModule)
    Crossing.loadSettingsFromSlot(1)
    PublicTransportSettings.loadSettingsFromSlot(2)
    ---------------------------------------------------------------------------------------------------------------
