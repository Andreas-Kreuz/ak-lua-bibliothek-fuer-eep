...
-- Ampel K1 ist gleichzeitig eine Fu�g�ngerampel
local K8 = TrafficLight:new("K8", 17, TrafficLightModel.JS2_2er_OFF_YELLOW_GREEN) -- Ampel K8 ist nur f�r Rechtsabbieger
...
local K6 = TrafficLight:new("K6", 13, TrafficLightModel.JS2_3er_ohne_FG) -- dies ist keine Fu�g�ngerampel
local K7 = TrafficLight:new("K7/F6", 11, TrafficLightModel.JS2_3er_mit_FG)

-- Ampeln f�r die Stra�enbahn nutzen die Lichtfunktion der einzelnen Immobilien
...
local F1 =
    K1 -- Die Fussg�ngerampel F1 ist die selbe, wie Ampel K1, zeigt aber sp�ter "Fu�g�nger gr�n"
local F2 = K2
local F3 = K3
local F4 = K4
local F5 = K5
...
-- K7 muss sp�ter gleichzeitig leuchten (Signal ID 11)
