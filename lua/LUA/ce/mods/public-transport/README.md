...
permalink: lua/ce/mods/public-transport/
feature-img: "/docs/assets/headers/SourceCode.png"
img: "/docs/assets/headers/SourceCode.png"
---

## Paket `ce.mods.public-transport`
...
Für paketweite Anzeigeeinstellungen gibt es das Objekt `PublicTransportSettings`.

- `PublicTransportSettings.loadSettingsFromSlot(eepSaveId)` lädt die Einstellungen aus einem EEP-Speicherslot.
- `PublicTransportSettings.setShowDepartureTippText(boolean)` schaltet Tipp-Texte für Abfahrtsanzeigen ein oder aus.
