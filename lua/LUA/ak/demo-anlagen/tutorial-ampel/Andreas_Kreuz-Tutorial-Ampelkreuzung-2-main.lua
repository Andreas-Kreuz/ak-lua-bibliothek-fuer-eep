...
local K1 = TrafficLight:new(07, TrafficLightModel.JS2_3er_mit_FG) -- Ampel K1 ist gleichzeitig eine Fußgängerampel
...
local K6 = TrafficLight:new(13, TrafficLightModel.JS2_3er_ohne_FG) -- dies ist keine Fußgängerampel
...
sch1:addLane(o1)
sch1:addTrafficLight(K3)
sch1:addTrafficLight(K4)
sch1:addLane(os)
sch1:addTrafficLight(S1)
sch1:addLane(w1)
sch1:addTrafficLight(K5)
sch1:addLane(ws)
sch1:addTrafficLight(S2)
sch1:addPedestrianLight(F1, F2)

--- Tutorial 2: Schaltung 2
local sch2 = CrossingSequence:new("Schaltung 2")
sch2:addLane(w2)
sch2:addTrafficLight(K6)
sch2:addTrafficLight(K7)
sch2:addPedestrianLight(F3, F4)

--- Tutorial 2: Schaltung 3
local sch3 = CrossingSequence:new("Schaltung 3")
sch3:addLane(n)
sch3:addTrafficLight(K1)
sch3:addTrafficLight(K2)
sch3:addPedestrianLight(F3, F4)
sch3:addPedestrianLight(F5, F6)
